...
TARGETS="author.cmo board.cmo main.cmo test.cmo"
ZIP=adventure.zip
...
print_fatal "Currently not checking for required definitions- TODO"
...
print_meta "Not checking hours worked- unnecessary?"
